...
SRC_URI="https://github.com/KhronosGroup/Vulkan-ValidationLayers/tarball/9a31edfa80d5c5c85b238a0ec3963320fdfc91f0 -> Vulkan-ValidationLayers-1.3.233-9a31edf.tar.gz"
...
DEPEND="
	...
	=dev-util/vulkan-headers-1.3.234*
	${PYTHON_DEPS}
