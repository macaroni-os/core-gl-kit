...
SRC_URI="
amd64? ( https://developer.download.nvidia.com/compute/cuda/12.9.2/local_installers/cuda_12.9.2_575.57.08_linux.run -> nvidia-cuda-toolkit-12.9.2_575.57.08_linux_x86_64.run )
arm64? ( https://developer.download.nvidia.com/compute/cuda/12.9.2/local_installers/cuda_12.9.2_575.57.08_linux_sbsa.run -> nvidia-cuda-toolkit-12.9.2_575.57.08_linux_arm64.run )"
LICENSE="NVIDIA-CUDA"
SLOT="0"
KEYWORDS="*"
...
src_install() {
	...
	sed -i -e 's|VERSION|12.9.2|g' nvidia-cuda-toolkit.pc
