...
SRC_URI="
amd64? ( https://developer.download.nvidia.com/compute/cuda/13.3.1/local_installers/cuda_13.3.1_610.43.02_linux.run -> nvidia-cuda-toolkit-13.3.1_610.43.02_linux_x86_64.run )
arm64? ( https://developer.download.nvidia.com/compute/cuda/13.3.1/local_installers/cuda_13.3.1_610.43.02_linux_sbsa.run -> nvidia-cuda-toolkit-13.3.1_610.43.02_linux_arm64.run )"
LICENSE="NVIDIA-CUDA"
SLOT="0"
KEYWORDS="*"
...
src_install() {
	...
	sed -i -e 's|VERSION|13.3.1|g' nvidia-cuda-toolkit.pc
